...
(cl:in-package detectDarkness-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <move_direction-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'move_direction-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name detectDarkness-srv:<move_direction-request> is deprecated: use detectDarkness-srv:move_direction-request instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <move_direction-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader detectDarkness-srv:x-val is deprecated.  Use detectDarkness-srv:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <move_direction-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader detectDarkness-srv:y-val is deprecated.  Use detectDarkness-srv:y instead.")
  (y m))

(cl:ensure-generic-function 'angle-val :lambda-list '(m))
(cl:defmethod angle-val ((m <move_direction-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader detectDarkness-srv:angle-val is deprecated.  Use detectDarkness-srv:angle instead.")
  (angle m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<move_direction-request>)))
  ...
  "detectDarkness/move_directionRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'move_direction-request)))
  "Returns string type for a service object of type 'move_direction-request"
  "detectDarkness/move_directionRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <move_direction-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'move_direction-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name detectDarkness-srv:<move_direction-response> is deprecated: use detectDarkness-srv:move_direction-response instead.")))

(cl:ensure-generic-function 'reply-val :lambda-list '(m))
(cl:defmethod reply-val ((m <move_direction-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader detectDarkness-srv:reply-val is deprecated.  Use detectDarkness-srv:reply instead.")
  (reply m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<move_direction-response>)))
  ...
  "detectDarkness/move_directionResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'move_direction-response)))
  "Returns string type for a service object of type 'move_direction-response"
  "detectDarkness/move_directionResponse")
