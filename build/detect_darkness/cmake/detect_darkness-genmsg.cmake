...
add_custom_target(detect_darkness_generate_messages ALL)
...
_generate_module_cpp(detect_darkness
  ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/detect_darkness
  "${ALL_GEN_OUTPUT_FILES_cpp}"
)

add_custom_target(detect_darkness_generate_messages_cpp
...
add_custom_target(detect_darkness_gencpp)
add_dependencies(detect_darkness_gencpp detect_darkness_generate_messages_cpp)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS detect_darkness_generate_messages_cpp)
...
### Generating Module File
_generate_module_eus(detect_darkness
  ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/detect_darkness
  "${ALL_GEN_OUTPUT_FILES_eus}"
)

add_custom_target(detect_darkness_generate_messages_eus
...
# target for backward compatibility
add_custom_target(detect_darkness_geneus)
add_dependencies(detect_darkness_geneus detect_darkness_generate_messages_eus)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS detect_darkness_generate_messages_eus)
...
### Generating Module File
_generate_module_lisp(detect_darkness
  ${CATKIN_DEVEL_PREFIX}/${genlisp_INSTALL_DIR}/detect_darkness
  "${ALL_GEN_OUTPUT_FILES_lisp}"
)

add_custom_target(detect_darkness_generate_messages_lisp
...
# target for backward compatibility
add_custom_target(detect_darkness_genlisp)
add_dependencies(detect_darkness_genlisp detect_darkness_generate_messages_lisp)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS detect_darkness_generate_messages_lisp)
...
### Generating Module File
_generate_module_nodejs(detect_darkness
  ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/detect_darkness
  "${ALL_GEN_OUTPUT_FILES_nodejs}"
)

add_custom_target(detect_darkness_generate_messages_nodejs
...
# target for backward compatibility
add_custom_target(detect_darkness_gennodejs)
add_dependencies(detect_darkness_gennodejs detect_darkness_generate_messages_nodejs)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS detect_darkness_generate_messages_nodejs)
...
### Generating Module File
_generate_module_py(detect_darkness
  ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/detect_darkness
  "${ALL_GEN_OUTPUT_FILES_py}"
)

add_custom_target(detect_darkness_generate_messages_py
...
# target for backward compatibility
add_custom_target(detect_darkness_genpy)
add_dependencies(detect_darkness_genpy detect_darkness_generate_messages_py)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS detect_darkness_generate_messages_py)



if(gencpp_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/detect_darkness)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/detect_darkness
...
if(genlisp_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genlisp_INSTALL_DIR}/detect_darkness)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${genlisp_INSTALL_DIR}/detect_darkness
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/detect_darkness)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/detect_darkness\")")
  # install generated code
  install(
